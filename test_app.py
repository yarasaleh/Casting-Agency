...
class AgencyTestCase(unittest.TestCase):
    ...
    def test070_404_get_actors(self):
        result = self.client.get('/all_actors', headers = self.headers_Executive_Producer)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
        self.assertEqual(data["error"],404)
        self.assertEqual(data["message"],"resource not found")
    ...
    def test0920_update_actor(self):
        ...
        result = self.client.patch('/actor/1',json=actor, headers = self.headers_Casting_Director)
        data = json.loads(result.data)
        self.assertEqual(data["success"],True)
    ...
    def test0930_404_update_actor(self):
        ...
        result = self.client.patch('/actor/100',json=actor, headers= self.headers_Casting_Director)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
        self.assertEqual(data["error"],404)
        self.assertEqual(data["message"],"resource not found")
    ...
    def test0950_404_remove_actor(self):
        result = self.client.delete('/actor/100',headers=self.headers_Executive_Producer)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
        self.assertEqual(data["error"],404)
        self.assertEqual(data["message"],"resource not found")
    ...
    def test0970_404_delete_movie(self):
        result = self.client.delete('/movie/100',headers=self.headers_Executive_Producer)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
        self.assertEqual(data["error"],404)
        self.assertEqual(data["message"],"resource not found")
    ...
    def test0980_Casting_Director(self):
        ...
        result = self.client.post('/movie',json=new_movie,headers=self.headers_Casting_Director)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
    ...
    def test0990_Casting_Assistant(self):
        ...
        result = self.client.post('/movie',json=new_movie,headers=self.headers_Casting_Assistant)
        data = json.loads(result.data)
        self.assertEqual(data["success"],False)
        self.assertEqual(data["error"],401)
        self.assertEqual(data["message"]["code"],"unauthorized")
